...
-- OWNERS
INSERT IGNORE INTO owners (id, first_name, last_name, address, city, telephone)
...
-- VISITS
-- Deine visits-Tabelle hat mehr Spalten (notes, procedure_type, visit_time, vet_name).
-- Deshalb hier NUR die alten vier Spalten explizit befüllen:
INSERT IGNORE INTO visits (id, pet_id, visit_date, description)
